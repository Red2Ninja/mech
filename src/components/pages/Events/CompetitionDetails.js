...
const competitionData = {
  'Aerodash 2.0': {
    image: '/images/event/marinaX.jpg', 
  ...
  'Mechnovate Drone Racing Challenge (MDRC)': {
    ...
    pdf: 'https://drive.google.com/file/d/1LGtwZXzlzjb7UO3-6kqu0ntUJKgQX9Jq/view?usp=drive_link',
    details: [
